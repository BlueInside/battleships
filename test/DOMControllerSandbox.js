...
function renderPlayerBoards(player1, player2) {
  ...
  player1BoardElement.innerHTML = generateBoardHTML(player1Board);
  player2BoardElement.innerHTML = generateBoardHTML(player2Board);
}
...
renderPlayerBoards(player1, player2);
